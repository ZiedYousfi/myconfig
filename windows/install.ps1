...
'@
    ...
    Write-Log "Configuring startup shortcuts for GlazeWM and Zebar..." -Level 'INFO'

    # Remove any registry startup entries (user preference for shortcuts)
...
function Main {
    ...
    Write-Log "  2. GlazeWM and Zebar will start automatically via startup shortcuts" -Level 'INFO'
    if (-not $SkipWSL) {
